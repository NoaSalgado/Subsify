...
public interface ISubscriptionService {
    ...
    EntityResult subscriptionInsertAll(Map<String, Object> attributes) throws OntimizeJEERuntimeException;
    EntityResult subscriptionQueryUpdate(Map<String, Object> keysValues, List<String> attributes) throws OntimizeJEERuntimeException;
}
